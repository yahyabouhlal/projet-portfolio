...
$sql = "UPDATE project SET Name = ?,Description = ?,Image = ?,Github = ?,Category=? WHERE id = ?";
$stmt = $db_connect->prepare($sql);

if ($stmt->execute(array($Name,$Description,$Image,$Github,$Category,$id))){
 ...
 foreach($data as $projet) {
    ...
    <div class="form-group">
      ...
      <select class="form-control" name="Category">
        <option>app</option>
        <option selected = "selected">icon</option>
     </div>
    </select>
    </div>
